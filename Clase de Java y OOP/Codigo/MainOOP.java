...
import seresvivos.chordata.Animal;
import seresvivos.chordata.Chordata;
import seresvivos.chordata.Mamifero;
import seresvivos.especiales.AnimalCompania;
import seresvivos.humanos.Humano;
...
public class MainOOP {
	...
	public static void pruebasMamifero() {
		
		Mamifero mam = new Mamifero("Simius Monus", 2, 35.5, 0.8, true, true, true, true, true, true);
		Mamifero mam2 = new Mamifero("Simius Monus", 2, 35.5, 0.8, true, true, true, true, true, true);
	...
	public static void pruebasPrimate() {
		
		AnimalCompania animal = new AnimalCompania("Canis Canis", 0, 25.0, 0.6, true, true, false, false, true, true, "Juana", "Calle de Juana 7, Tijuana, Mexico");
		AnimalCompania animal2 = new AnimalCompania("Canis Canis", 0, 25.0, 0.6, true, true, false, false, true, true, "Juana", "Calle de Juana 7, Tijuana, Mexico");
	...
	public static void pruebasHumano() {
		...
		Humano h = new Humano("Homo Sapiens", 0, 1.3, 0.23, true, false, false, false, false, true, "Juana Juanilla", "Calle de Juana 7, Tijuana, Mexico", "Ju An", "todavia no ha nacido", "Feto", 0);
		Humano h2o = new Humano("Homo Sapiens", 0, 1.3, 0.23, true, false, false, false, false, true, "Juana Juanilla", "Calle de Juana 7, Tijuana, Mexico", "Ju An", "todavia no ha nacido", "Feto", 0);
	...
	public static void pruebasListaEnlazada() {
		...
		h = new Humano("Homo Sapiens", 0, 1.3, 0.23, true, false, false, false, false, true, "Juano Juanillo", "Calle de Juana 7, Tijuana, Mexico", "Ju An", "todavia no ha nacido", "Feto", 0);
		Nodo n2 = new Nodo(h, null);
		System.out.println(n2);
		h = new Humano("Homo Sapiens", 0, 25, 0.8, true, false, false, false, false, true, "Victor Victoria", "Calle de Juana 7, Tijuana, Mexico", "Ju An", "todavia no ha nacido", "Feto", 0);
		Nodo n3 = new Nodo(h, null);
		h = new Humano("Homo Sapiens", 0, 27, 0.9, true, false, false, false, false, true, "Victoria Victor", "Calle de Juana 7, Tijuana, Mexico", "Ju An", "todavia no ha nacido", "Feto", 0);
		Nodo n4 = new Nodo(h, null);
		
		ListaEnlazada lista = new ListaEnlazada();
			
		System.out.println(lista.getNodo(0).toString());
