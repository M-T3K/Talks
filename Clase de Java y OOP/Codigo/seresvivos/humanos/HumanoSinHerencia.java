...
public class HumanoSinHerencia {
	...
	//private String  especie; // En este caso, al no ser extendible ni heredar, nos lo podemos ahorrar porque la especie siempre sera la misma
	...
	HumanoSinHerencia(boolean espina_dorsal, boolean cola, boolean pulmones, boolean glandulas_mamarias, 
			boolean cuerpo_peludo, boolean sexo, int edad, int inteligencia, double peso, double tamano,
			String nombre, String direccion, String apellidos, String nacimiento, String ocupacion) {
	...
	public boolean equals(Object Obj) {
		...
		if(Obj instanceof HumanoSinHerencia) {
			
			HumanoSinHerencia h = (HumanoSinHerencia)(Obj);
			return true; 
